...
export const spells: CharacterSpell[] = [
  ...
  // Добавляем новые заклинания
  {
    ...
    components: "В, С",
    duration: "Мгновенно",
    description: "Молния срывается с вашей руки и перескакивает на существо, которого вы пытаетесь коснуться. Совершите рукопашную атаку заклинанием против цели. При попадании цель получает урон электричеством 1d8, и не может совершить реакцию до начала своего следующего хода.",
    classes: ["Волшебник", "Чародей"]
  },
  {
    ...
    components: "В, С",
    duration: "Мгновенно",
    description: "Вы простираете руку к существу, которое видите в пределах дистанции, и выпускаете из ладони клубы токсичного газа. Существо должно преуспеть в спасброске Телосложения, иначе получит урон ядом 1d12.",
  ...
  },
  {
    ...
    castingTime: "1 действие",
    range: "На себя",
    components: "С, М (немного косметики)",
    duration: "1 минута (концентрация)",
    description: "На время действия заклинания вы получаете преимущество на все проверки Харизмы, направленные на одно существо, которое вы выбрали и которое не настроено к вам враждебно. Когда заклинание оканчивается, существо понимает, что вы использовали на нём магию, и становится враждебным по отношению к вам. Агрессивные действия с вашей стороны мгновенно завершают это заклинание.",
    classes: ["Бард", "Волшебник", "Чернокнижник"]
  },
  {
    ...
    components: "В, С",
    duration: "Мгновенно",
    description: "Подобное языкам пламени, нисходящее с небес сияние окружает существо, которое вы видите в пределах дистанции. Цель должна преуспеть в спасброске Ловкости, иначе получит урон огнём 1d8. Цель не получает преимущества от укрытия при этом спасброске.",
    classes: ["Жрец"]
  },
  {
    ...
    components: "В, С",
    duration: "Мгновенно",
    description: "Вы создаёте один из следующих эффектов в пределах дистанции:\n• Вы создаёте крошечный, безвредный сенсорный эффект, предсказывающий погоду. Если завтра будет дождь, падают капли дождя, идёт снег, дует лёгкий ветерок.\n• Вы мгновенно зажигаете или тушите свечу, факел или маленький костёр.\n• Вы мгновенно очищаете или пачкаете предмет объёмом не более 1 кубического фута.\n• Вы охлаждаете, согреваете или придаёте вкус до 1 кубического фута неживого материала на 1 час.\n• Вы заставляете цветок распуститься, семя прорасти или почку набухнуть в течение 1 минуты.",
    classes: ["Друид"]
  },
  {
    name: "Брызги кислоты",
    ...
    components: "В, С",
    duration: "Мгновенно",
    description: "Вы бросаете пузырёк с кислотой. Выберите одно существо, которое вы видите в пределах дистанции, или двух существ, находящихся в пределах 1,5 метров друг от друга. Цель должна преуспеть в спасброске Ловкости, иначе получит урон кислотой 1d6.",
    classes: ["Волшебник"]
  },
  {
    name: "Указание",
    ...
    components: "В, С",
    duration: "1 раунд",
    description: "Вы указываете пальцем на цель в пределах дистанции, и окружающее её пространство на короткое время загорается мистическим светом. До конца вашего следующего хода любое существо, попадающее по этой цели атакой, получает преимущество на первый бросок атаки.",
  ...
  },
  {
    ...
    duration: "1 минута (концентрация)",
    description: "Вы касаетесь одного согласного существа. Пока заклинание активно, цель может бросить d4 один раз и добавить выпавшее число к одному спасброску по своему выбору. Кость можно бросить перед или после броска спасброска. После этого заклинание оканчивается.",
    classes: ["Жрец", "Друид"]
  },
  {
    name: "Усыпление",
    ...
    castingTime: "1 действие",
    range: "36 метров",
    components: "В, С, М (щепотка песка)",
    duration: "1 минута",
    description: "Это заклинание погружает существ в магический сон. Бросьте 5d8; результат — это число хитов существ, на которых подействует это заклинание. Существа в пределах 6 метров от точки, которую вы выбрали в пределах дистанции, затрагиваются в порядке увеличения их текущих хитов (существа в бессознательном состоянии игнорируются). Начиная с существа с наименьшим текущим значением хитов, все существа, затронутые этим заклинанием, падают без сознания, пока заклинание не окончится, цель не получит урон, или кто-нибудь не разбудит цель действием, либо не встряхнёт её или не ударит. Вычтите хиты каждого существа из общего счёта, прежде чем перейти к существу со следующим наименьшим количеством хитов. Хиты существа должны быть равны оставшемуся счёту или быть меньше него, чтобы на это существо подействовало заклинание. Нежить и существа, обладающие иммунитетом к очарованию, не попадают под действие этого заклинания.",
    higherLevels: "Если вы накладываете это заклинание, используя ячейку 2-го уровня или выше, бросайте дополнительно 2d8 за каждый уровень ячейки выше первого.",
  ...
  },
  {
    ...
    components: "В, С",
    duration: "1 час",
    description: "Вы меняете свой облик, пока заклинание не закончится или пока вы не используете действие для его отмены. Вы можете принять любой облик по своему выбору, не меняющий боевой формы. Вы не можете изменять свои показатели характеристик, изменять боевую форму или принимать облик существа с другими игровыми значениями, кроме подражания другому существу вашей формы. Если вы используете это заклинание для того, чтобы притвориться другим существом, вы должны преуспеть в провер
