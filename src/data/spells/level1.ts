...
export const level1Spells: CharacterSpell[] = [
  {
    name: 'Благословение',
    level: 1,
    school: 'Очарование',
    ...
    description: 'Вы благословляете до трёх существ на ваш выбор в пределах дистанции. Каждый раз, когда цель совершает бросок атаки или спасбросок до окончания заклинания, она может бросить к4 и добави��ь результат к броску.',
    higherLevels: 'При использовании ячейки заклинания 2 уровня или выше вы можете сделать целью одно дополнительное существо за каждый уровень ячейки выше первого.',
  ...
  },
  {
    ...
    material: true,
    duration: '1 час',
    description: 'Защитная магическая сила окружает вас, прояв��ся в виде призрачной изморози, и вы получаете 1к4 + 4 временных хита на время действия заклинания.',
    classes: ['Волшебник'],
