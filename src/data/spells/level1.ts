...
export const level1: CharacterSpell[] = [
  ...
  },
  {
    ...
    material: true,
    duration: "Мгновенная",
    description: "Вы либо создаёте, либо уничтожаете воду. Сотворение воды: Вы создаёте до 10 галлонов чистой воды в открыем контейнере в пределах дистанции. В качестве альтернативы, вода выпадает дождём в кубе с длиной ребра 30 футов, гася открытый огонь в этой области. Уничтожение воды: Вы уничтожаете до 10 галлонов воды в открыем контейнере в пределах дистанции.",
    classes: ["Друид", "Жрец"]
  },
  {
    id: "level1-40",
