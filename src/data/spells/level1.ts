...
export const level1Spells = [
  {
    ...
    ritual: false,
    duration: "Мгновенная",
    description: "Существо на ваш выбор, видимое в пределах дистанции, восстанавливает количество хитов, равное 1d4 + ваш модификатор базовой характеристики. Это заклинание не оказывает никакого эффекта на нежить и ��онструктов.",
    higherLevels: "Если вы накладываете это заклинание, используя ячейку 2-го уровня или выше, количество восстанавливаемых хитов увеличивается на 1d4 за каждый уровень ячейки выше первого.",
  ...
  },
  {
    ...
    material: false,
    duration: "1 час",
    description: "Вы пытаетесь очаровать гуманоида, которого видите в пределах дистанции. Он должен совершить спасбросок Мудрости, и с преимуществом, если вы или ваши спутники сражаетесь с ним. При провале он очарован вами, пока ��аклинание активно или пока вы или ваши спутники не причините ему вред.",
  ...
  },
  {
    ...
    material: true,
    duration: "1 час",
    description: "Защитная магическая сила окружает вас, проявл��ся в виде призрачной изморози, и вы получаете 1к4 + 4 временных хита на время действия заклинания.",
    classes: ["Волшебник"],
  ...
  },
  {
    ...
    classes: ["Чародей", "Волшебник"],
    higherLevels: "Когда вы накладываете это заклинание, ис��ользуя ячейку заклинания 2 уровня или выше, урон увеличивается на 1к8 за каждый уровень ячейки выше 1.",
    prepared: false
  },
  {
    name: "Церемония",
