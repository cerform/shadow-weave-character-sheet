...
export const races = [
  ...
  },
  {
    ...
    traits: [
      "Везучий: Если у вас выпало «1» на к20 при броске атаки, проверке характеристики или спасброске, вы можете перебросить кость, но должны использовать новый результат.",
  ...
  },
  {
    ...
    traits: [
      ...
      "Небесное сопротивление: Вы получаете сопротивление к урону некротической энергией и излучением.",
