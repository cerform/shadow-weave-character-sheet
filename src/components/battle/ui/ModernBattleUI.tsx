...
export const ModernBattleUI: React.FC<ModernBattleUIProps> = ({
  ...
  const handleDefense = () => {
    ...
    toast({
      title: "Защита!",
      description: "Защитная стойка принята!",
    });
    if (activeToken) {
  ...
  const handleDiceRoll = () => {
    ...
    toast({
      title: "Кубик брошен!",
      description: "Бросок кубика выполнен!",
    });
  ...
  const handleMagic = () => {
    ...
    toast({
      title: "Магия!",
      description: "Заклинание использовано!",
    });
    if (activeToken) {
                           ...
                           value={[brushSize]}
                            onValueChange={(value) => {
                              ...
                              toast({
                                ...
                                description: `Размер кисти: ${value[0] === 0 ? '1 клетка' : `${value[0] * 2 + 1} клеток`}`,
                              });
