  ...
  useEffect(() => {
    const loadCharacter = async () => {
      try {
        ...
        // Получаем всех персонажей из localStorage
        const savedCharacters = localStorage.getItem("dnd-characters");
        
        if (savedCharacters) {
          const characters = JSON.parse(savedCharacters);
          const foundCharacter = characters.find((char: Character) => char.id === id);
          ...
          // Если список персонажей пуст, переходим на страницу создания
          setTimeout(() => {
