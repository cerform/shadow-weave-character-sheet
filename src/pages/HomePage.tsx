...
const HomePage = () => {
  ...
  const quickActions = [
    ...
    {
      icon: Crown,
      title: isDM ? "Панель Мастера" : "Мои игровые сессии",
      description: isDM 
        ? "Современная панель DM с инициативой, токенами, туманом войны и VTT интерфейсом"
        : "Список активных игровых сессий, в которых вы участвуете",
      href: isDM ? "/dm" : "/player-sessions",
